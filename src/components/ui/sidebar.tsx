...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden text-sidebar-foreground md:block overflow-hidden"
        data-state={state}
      ...
      >
        ...
        <div
          className={cn(
            "relative w-(--sidebar-width) bg-transparent transition-[width] duration-[250ms] ease-linear",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) overflow-hidden transition-[left,right,width] duration-[250ms] ease-linear md:flex",
            side === "left"
